...
## Project setup
1. Fork repository ini. Ada tombol 'fork' di kanan atas atau klik https://github.com/miqbalhamdani/binar-challenge-chapter-8-/fork. Nanti akan muncul repository yang sama persis di akun teman-teman.
...
atau
```
$ git clone git@github.com:username_kalian/binar-challenge-chapter-8.git
```
...
## Petunjuk Submission
- Challenge di submit paling lambat hari kamis di minggu ketiga chapter 8, pukul 23:59 WIB.
...
- pastikan github nya untuk tidak di private
